...
const itens = ["Anderson", true, 2, 4.12];
...
// 10 - loop em array
const users = ["Anderson", "João", "Ben", "Miguel"];
...
const posts = [
    { title: "Primeiro post", category: "React" },
    { title: "Segundo post", category: "JavaScript" },
    { title: "Terceiro post", category: "Typescript" },
];
...
// 27 - json
const myJson =
    '{"name": "Anderon","age": 28, "skills": ["React", "JavaScript", "Typescript"]}';
...
// json invalido
const badJson =
    '{"name": Anderson,"age": 28, "skills": ["React", "JavaScript", "Typescript"]}';
